  ...
  return (
    <div className="container ml-auto mr-auto">
      ...
      <div className="w-3/5 mt-10 m-auto">
        <Input type="text" placeholder="一切皆可查..." name="search" className="m-auto w-full pl-5 h-16 bg-amber-50 border border-gray-800 rounded-2xl data-focus:bg-blue-100 data-hover:shadow" />
      </div>
      <div className="flex justify-start w-3/5 m-auto mt-5 gap-2 text-sm pl-5 text-gray-500">
